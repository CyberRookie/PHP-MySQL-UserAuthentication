...
<!--10/27/21 11AM - Trying to register a new account in the  accounts schema -->
<head>
    <meta charset="UTF-8">
...
crossorigin="anonymous">
    ...
    -->
<title>Testing Account Registration</title>
<style>
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	require('db_inc.php'); // Connect to the db.

	$errors = []; // Initialize an error array.

	// Check for a first name:
	if (empty($_POST['account_name'])) {
		$errors[] = 'You forgot to enter account name.';
	} else {
		$fn = mysqli_real_escape_string($dbc, trim($_POST['account_name']));
	}
	...
	if (empty($errors)) { // If everything's OK.
		...
		// Make the query:
		$q = "INSERT INTO account (account_name, account_password, account_reg_time) VALUES ('$fn', SHA2('$p', 512), NOW() )";
...
?>
	<div id="content">
<h1>Register</h1>
<!--Changed from register.php to account_class.php -->
<form action="account_class.php" method="post">
	<p>Account Name: <input type="text" name="account_name" size="15" maxlength="20" value="<?php if (isset($_POST['account_name'])) echo $_POST['account_name']; ?>"></p>

	<p>Password: <input type="password" name="account_password" size="10" maxlength="20" value="<?php if (isset($_POST['account_password'])) echo $_POST['account_password']; ?>" ></p>
<!--
